...
local defaults = {
  ...
  keys = {
    ...
    { mode = "x", key = "<leader>rc",  func = function() stt:TransferCamelCase()  end },
    { mode = "n", key = "crm", func = function() stt:TransferMixedCase()  end },
    { mode = "x", key = "<leader>rm",  func = function() stt:TransferMixedCase()  end },
    { mode = "n", key = "crs", func = function() stt:TransferStrCase("_") end },
    { mode = "x", key = "<leader>rs",  func = function() stt:TransferStrCase("_") end },
    { mode = "n", key = "cr-", func = function() stt:TransferStrCase("-") end },
    { mode = "x", key = "<leader>r-",  func = function() stt:TransferStrCase("-") end },
    { mode = "n", key = "cr ", func = function() stt:TransferStrCase(" ") end },
    { mode = "x", key = "<leader>r ",  func = function() stt:TransferStrCase(" ") end },
    { mode = "n", key = "cr.", func = function() stt:TransferStrCase(".") end },
    { mode = "x", key = "<leader>r.",  func = function() stt:TransferStrCase(".") end },
